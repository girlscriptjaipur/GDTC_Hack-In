...
import vyomchandra.com.healthcalculator.adapters.NotesAdapter;
import vyomchandra.com.healthcalculator.callbacks.MainActionModeCallback;
...
import static vyomchandra.com.healthcalculator.EditNoteActivity.NOTE_EXTRA_Key;
...
////        // init recyclerView
    ...
    private void showEmptyView() {
        if (notes.size() == 0) {
            ...
            findViewById(R.id.emptynotes).setVisibility(View.VISIBLE);

        } else {
            this.recyclerView.setVisibility(View.VISIBLE);
            findViewById(R.id.empty_notes_view).setVisibility(View.GONE);
            findViewById(R.id.emptynotes).setVisibility(View.GONE);
        }
    }
